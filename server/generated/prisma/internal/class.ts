...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more Trainig_plans
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.trainig_plans`: Exposes CRUD operations for the **trainig_plans** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Trainig_plans
    * const trainig_plans = await prisma.trainig_plans.findMany()
    * ```
    */
  get trainig_plans(): Prisma.trainig_plansDelegate<ExtArgs, { omit: OmitOpts }>;
